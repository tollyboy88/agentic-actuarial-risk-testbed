...
This prototype executed **60 runs** across **2 synthetic insurer worlds** and **3 workflow topologies**. It preserves every stage trajectory and uses paired, same-world no-fault controls to isolate injected-fault effects.

The minimum-objective control package in this scenario is **T2_VALIDATOR**, with VaR 99.5% of **GBP 55,000**, expected shortfall 99.5% of **GBP 59,428**, and annual control cost **GBP 1**. The largest observed paired reserve movement was **GBP 63,407,119** (F1_DATA injected at S1_INGEST under T1_LINEAR).
